...
React is a UI library built by Facebook to help solve problems when dealing with complex State.

- [x] What does it mean to _think_ in react?
It means to be able to break a project down into components and understand how they work together

- [x] Describe state.
State is the data

- [x] Describe props.
Props are arguements passed into components. 
